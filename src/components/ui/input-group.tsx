...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      role="group"
      className={cn(
        "group/input-group border-neutral-200 dark:bg-neutral-200/30 shadow-2xs relative flex w-full items-center rounded-md border outline-hidden transition-[color,box-shadow] dark:border-neutral-800 dark:dark:bg-neutral-800/30",
