...
export function ProfileHeader({ user }: ProfileHeaderProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-linear-to-br from-slate-900 via-blue-900 to-indigo-900 shadow-2xl">
      ...
      <div className="relative p-8 md:p-12">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-linear-to-br from-blue-400 to-purple-500 blur-xl opacity-50 scale-110" />
            <Avatar className="relative h-28 w-28 md:h-36 md:w-36 border-4 border-white/20 shadow-2xl ring-4 ring-white/10">
              <AvatarImage src={user.image || undefined} alt={user.name} />
              <AvatarFallback className="text-3xl md:text-4xl bg-linear-to-br from-blue-500 to-purple-600 text-white font-bold">
                {initials}
              </AvatarFallback>
            </Avatar>
          </div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm">
              <div className="flex items-center gap-2 bg-white/10 backdrop-blur-xs rounded-full px-4 py-2 text-white/90">
